...
var _lodash = require("lodash"); // 2 ways to import
...
console.log((0, _momentDefault.default)("20150911", "YYYYMMDD").from("20141111"));
//   Check if the year 2020 is a leap year
console.log((0, _momentDefault.default)().isLeapYear(2016));
// Check is 2010-01-01 date after 2018-01-01
console.log((0, _momentDefault.default)("20100101").isAfter("20180101"));
// adds 7 days to current date
console.log((0, _momentDefault.default)().add(7, "days").calendar());
// adds 7 months to current date
console.log((0, _momentDefault.default)().add(7, "month").calendar());

},{"lodash":"3qBDj","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","moment":"jwcsj"}],"3qBDj":[function(require,module,exports) {
var global = arguments[3];
(function() {
...
},{}]},["2UeK4","bB7Pu"], "bB7Pu", "parcelRequire77d5")
